  ...
  return (
   ...
   >
     <div className="text-center px-4">
        <h1 className="text-[64px] max-w-3xl  flex flex-col items-center  justify-start mx-auto font-bold mb-4">
        ...
        <p className="text-lg mb-6 max-w-3xl text-muted-foreground mx-auto">
